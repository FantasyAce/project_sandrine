 ...
 */
final class Version20200207075919 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media ADD image VARCHAR(255) NOT NULL, CHANGE added_at added_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media DROP image, CHANGE added_at added_at DATETIME DEFAULT \'NULL\'');
